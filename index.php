...
<html class="loading">
  <head>
    ...
    <title>TROPA DO SALVEEE AMAZON</title>
    ...
    <div class="col-md-8">
      <div class="card">
        <div class="card-body text-center">
          <h4 class="mb-2"><strong>ALLBINS (AMAZON TROPA DO SALVE)</strong></h4>
...
Swal.fire({ title: "AVISO SALVEEE TUDO ON BBS ", text: "Coder SALVEEE TUDO ", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
